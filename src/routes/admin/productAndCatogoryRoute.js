...
router.patch(
  ...
  cateAndProdController.listAndUnlistCategory
);
router.get(
  '/admin/category/edit/:id',
  cateAndProdController.getEditCategoryPage
);
...
router.post(
  '/admin/addProducts/add',
  upload.any(),
  cateAndProdController.addProduct
);
...
router.put(
  ...
  upload.any(),
  cateAndProdController.updateProduct
);
